...
task data: :environment do
  ...
  sources = [
    ...
    {q: 'business', sources: 'espn', domains: 'espn.go.com'},
    {q: 'entertainment', sources: 'espn', domains: 'espn.go.com'},
    {q: 'general', sources: 'espn', domains: 'espn.go.com'},
    {q: 'health', sources: 'espn', domains: 'espn.go.com'},
    {q: 'science', sources: 'espn', domains: 'espn.go.com'},
    {q: 'sports', sources: 'espn', domains: 'espn.go.com'},
    {q: 'technology', sources: 'espn', domains: 'espn.go.com'},
